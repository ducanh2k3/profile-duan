...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Lora:ital@1&family=Roboto:ital,wght@0,100;1,100&display=swap" rel="stylesheet">
...
<body>
        ...
        <div class="sticky">
            ...
            ?>
                ...
                <form action="" method="post">
                    ...
                    <br>
                     <button class="button button2"><a href="../view/dangbai.php">Đăng bài</a></button>
                </form>
                <?php
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <img src="https://cdn.tgdd.vn/Files/2021/04/11/1342554/mon-the-thao-ban-nen-thu-trong-nhung-ngay-he-de-9.jpg" style="width:1000px;height: 350px;">
            <div class="text">Sport</div>
        </div>

        <div class="mySlides fade">

            <img src="https://www.reconversionprofessionnelle.org/wp-content/uploads/2022/04/dessins-design-produit-innovant-990x556.png" style="width:1000px;height: 350px;">
            <div class="text">Design</div>
        </div>

        <div class="mySlides fade">

            <img src="https://www.healthcareitnews.com/sites/hitn/files/Doctor%20at%20computer%2C%20hologram%20illustration_2.jpg" style="width:1000px;height: 350px;">
